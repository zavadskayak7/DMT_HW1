...
def Empty_Schema(dataset,analyzer,schema):
    '''
    ...
    directory_containing_the_index = '../directory_index_' + dataset + '_' + str(analyzer)
    try:
...
def Fill_Empty_Schema(dataset,dir_idx,n):
    '''
    ...
    '''
    directory_containing_the_documents = '../' + dataset + '/DOCUMENTS/'
